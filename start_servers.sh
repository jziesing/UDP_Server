...
SERVER=~/Documents/Jack/432_Chat/UDP_Server/prog2/server

SERVER_NAME=`echo $SERVER | sed 's#.*/\(.*\)#\1#g'`

# Generate a simple two-server topology
#$SERVER localhost 9099 localhost 9088 &
#$SERVER localhost 9088 localhost 9099 & 

# Generate a capital-H shaped topology
$SERVER localhost 9090 localhost 9091 &
$SERVER localhost 9091 localhost 9090 localhost 9092 localhost 9093 &
$SERVER localhost 9092 localhost 9091 & 
$SERVER localhost 9093 localhost 9091 localhost 9095 &
$SERVER localhost 9094 localhost 9095 &
$SERVER localhost 9095 localhost 9094 localhost 9093 localhost 9096 &
$SERVER localhost 9096 localhost 9095 &
