...
void handle_server_input()
{
	...
	else
	{
		...
		if (message_type == TXT_SAY)
		{
			...
			printf("][");
			printf(say_text->txt_username);
			printf("]: ");
			printf(say_text->txt_text);
			printf("\n>");
		}
